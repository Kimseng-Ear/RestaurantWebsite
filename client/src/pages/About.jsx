      ...
      <div className="pt-24 min-h-screen bg-stone-50 text-stone-800 font-sans selection:bg-stone-800 selection:text-stone-50" ref={containerRef}>
         ...
         <section className="relative h-[75vh] flex items-center justify-center overflow-hidden border-b border-stone-200 group">
            <motion.div style={{ y: heroY }} className="absolute inset-0 z-0 origin-top">
               <img src="/images/LeisureLakeStory.jpg" className="w-full h-full object-cover grayscale-[10%]" alt="Lake Story" />
            ...
            <motion.div initial="hidden" animate="visible" variants={staggerContainer} className="relative z-10 text-center px-6 text-stone-50 space-y-6">
               ...
               <motion.h1 variants={fadeInUp} style={fontPlayfair} className="text-5xl md:text-7xl lg:text-8xl font-light tracking-tight max-w-5xl mx-auto leading-tight text-white">Where Waters Whisper Stories</motion.h1>
            </motion.div>
         ...
         <section className="py-32 max-w-[85rem] mx-auto px-6 lg:px-12 bg-white rounded-t-[4rem] -translate-y-12 relative z-20 shadow-[0_-20px_50px_-20px_rgba(0,0,0,0.05)]">
            <div className="text-center mb-24 max-w-2xl mx-auto space-y-6">
               ...
               <h2 style={fontPlayfair} className="text-4xl text-stone-900">Elevating Lakeside Living</h2>
            </div>

            <div className="space-y-32">
               {features.map((f, i) => (
                  <motion.div {...scrollFadeUpMargin} key={i} className={`flex flex-col lg:flex-row gap-16 items-center group cursor-pointer ${i % 2 !== 0 ? 'lg:flex-row-reverse' : ''}`}>
                     ...
                     <div className="lg:w-1/2 space-y-8 relative">
                        ...
                        <div>
                           ...
                           <h3 style={fontPlayfair} className="text-4xl font-light text-stone-900 tracking-tight transition-colors group-hover:text-emerald-800">{f.title}</h3>
                        </div>
         ...
         <section className="py-32 bg-stone-800 text-stone-50 relative overflow-hidden">
            ...
            <div className="max-w-[85rem] mx-auto px-6 lg:px-12 relative z-10">
               <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 items-center">
                  ...
                  <motion.div {...scrollFadeLeft} className="space-y-12 order-2 lg:order-1 relative">
                     ...
                     <div className="space-y-6">
                        ...
                        <h2 style={fontPlayfair} className="text-4xl md:text-5xl lg:text-6xl font-light tracking-tight leading-tight">Beyond a meal,<br /><span className="italic text-stone-400">a breath of life.</span></h2>
                     </div>
                     <div className="space-y-8 text-stone-400 italic text-[1.75rem] leading-relaxed font-light">
                        <p style={fontPlayfair}>
                  ...
                  {/* Collage */}
                  <motion.div {...scrollFadeRight} className="order-1 lg:order-2 grid grid-cols-2 gap-8 relative group">
                     <div className="space-y-8 mt-16 relative">
                        ...
                        <motion.div whileHover={{ scale: 1.05 }} className="aspect-square rounded-full overflow-hidden border border-stone-600 bg-stone-700 relative shadow-[0_0_50px_-20px_rgba(255,255,255,0.1)]">
                           ...
                           <div className="absolute inset-0 flex items-end justify-center pb-8 border-b-2 border-stone-500/30 rounded-full">
                              <p style={fontPlayfair} className="text-stone-300 italic text-sm">"Still Waters"</p>
                           </div>
                        </motion.div>
                     </div>
                     <div className="space-y-8">
                        <div className="aspect-square border border-stone-600 bg-stone-700 p-8 flex flex-col justify-center items-center text-center relative overflow-hidden">
                           ...
                           <p style={fontPlayfair} className="text-stone-200 text-2xl font-light relative z-10">Lakeside</p>
         ...
         <section className="py-32 max-w-[85rem] mx-auto px-6 lg:px-12 bg-white border-b border-stone-200">
            <motion.div {...scrollFadeUp} className="text-center mb-24 space-y-6">
               ...
               <h2 style={fontPlayfair} className="text-4xl md:text-5xl font-light text-stone-900 tracking-tight">The Journey Unfolds</h2>
            </motion.div>
            ...
            <div className="relative max-w-4xl mx-auto">
               ...
               <div className="space-y-16 lg:space-y-24 relative z-10">
                  {journey.map((item, i) => (
                     <motion.div {...scrollFadeUpMargin} key={i} className="relative flex flex-col md:flex-row items-start md:justify-between group cursor-pointer pl-[4.5rem] md:pl-0">
                        ...
                        <div className={`md:w-[45%] ${i % 2 === 0 ? 'md:text-right md:pr-20 md:ml-auto md:order-last' : 'md:text-left md:pl-20'}`}>
                           ...
                           <h4 style={fontPlayfair} className="text-2xl sm:text-3xl font-light text-stone-900 mb-4 group-hover:text-emerald-800 transition-colors duration-500">{item.title}</h4>
         ...
         <section className="py-32 bg-stone-50 text-center relative overflow-hidden">
            <motion.div {...scrollFadeUp} className="max-w-4xl mx-auto relative z-10 px-6 space-y-10">
               <h2 style={fontPlayfair} className="text-4xl md:text-5xl lg:text-6xl font-light tracking-tight text-stone-900 leading-tight">Come Write Your Story</h2>
